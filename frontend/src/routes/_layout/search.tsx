            ...
            {selectedItem && (
                ...
                <TableContainer>
                    ...
                    <Tbody>
                        ...
                        <Td color={!selectedItem.keywords ? "ui.dim" : "inherit"}>
                            {selectedItem.keywords ? (selectedItem.keywords.length > 20 ? `${selectedItem.keywords.substring(0, 20)}...` : selectedItem.keywords) : "N/A"}
                        </Td>
                        <Td>
